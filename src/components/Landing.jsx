...
const Landing = () => {
  ...
  //Content
        ...
        const navName = "thundhuja";
        const about1FullParagraph = "Hi I am $thundhuja, As a photographer I am dedicated to transforming ordinary moments into extraordinary memories.";
